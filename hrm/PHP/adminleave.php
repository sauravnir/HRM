...
if (isset($_POST['approve'])){
    ...
    if ($result){
        ...
        $update_data1 ="UPDATE leaverequest SET status='Accepted' where leave_date= '$leave_date' and employee_id ='$employ_id'";
...
if (isset($_POST['discard'])){
    ...
    if ($result){
        ...
        $update_data_2 ="UPDATE leaverequest SET status='Denied' where leave_date= '$leave_date' and employee_id ='$employ_id'";
