      ...
      if (openDropdown.classList.contains('show')) {
        openDropdown.classList.remove('show');
            ...
            <div class="dashboard-content">
                <h1 class="ContentTitle">My Details</h1><br><br>
            </div>
            ...
            <?php
                ...
                <input class="table1" type="submit" onclick="location.href='edit.php'" name="edit" value="Edit" style="background-color:#04AA6D; text-align:center; width:200px;color:white; padding:5px; cursor:pointer;">    
            </div>  
