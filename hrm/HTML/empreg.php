              ...
              <div class="">
                ...
                <form action="../PHP/registration.php" method="post">
                  <div class="container">
                    ...
                    <div>
                      <label>Contact :</label>
                      <input type="text" name="contact" placeholder="Contact" value="+977" size="2" required />
                    </div>
                ...
                <button type="submit" class="cancelbtn" name="submit" onclick="window.location.href='../HTML/dashboard.php'">Cancel</button>
              </div>
            </div>
          </div>
        </div>
