                ...
                <a>
                    ...
                    <div class="dropdown-wrapper">
                        <a class="dropdown-href" href="leavereq.php">
                            <div class="tab active1"><img src="../assets/request.png" alt="">
                ...
                ?>
                    ...
                    <div class="row">
                        <div class="leftLabel">
                            <h4>Reason:</h4>
                            <div class="right">
                            <textarea name="reason" id="" cols="50" rows="10" style="margin-left:160px;" required></textarea>
                        </div>
                        </div>
                    ...
                    value="Cancel"
                    style="background-color:red; text-align:center; width:100px;color:white; padding:5px; cursor:pointer;;display:relative; margin-left:5px;">
                    </div>
